document.addEventListener("DOMContentLoaded", () => {
    ...
    // Aktifkan klik pada project lama
  ...
  async function loadProjectData(projectName) {
    ...
    try {
      ...
      const keywordSearch = document.getElementById("searchKeyword")?.value || ""
      ...
      if (keywordSearch) summaryParams.append("search", keywordSearch)
  ...
  function renderMonitoringResults(data) {
    ...
    const keyword = document.querySelector(".project-item.active")?.innerText?.toLowerCase()
